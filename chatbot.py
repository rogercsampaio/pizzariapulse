...
API_KEY = os.environ.get("GEMINI_API_KEY", "AQ.Ab8RN6Ijjg1tpX3Ji6rarn88gv1JTzOljB2I2bIh3QS8Cy00tw")
...
prompt = ChatPromptTemplate.from_messages([
    (
        "system",
        "Você é Mario, atendente receptivo e eficiente da Pizzaria.\n\n"
        "Regras Operacionais:\n"
...
def render_chat_page():
    ...
    st.warning(
        ...
        "📱 **Atendimento mais rápido:** Entre em contato pelo WhatsApp **(61) 99816-1361**"
    )
